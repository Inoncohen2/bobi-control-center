...
> ## 🔒 קריאה בטוחה וניהול מאומת
>
> מסכי המידע קוראים רק דרך גשרי בובי. שינוי זמין רק למשאב ולפעולה שחוזה
> Home Assistant מפרסם בפועל, ותמיד עובר תצוגה מקדימה, אישור מפורש ואימות
> לאחר הביצוע. היישום אינו כותב ישירות לישות או למכשיר ואינו יכול להפעיל את
> מתג הכתיבה הראשי בעצמו.
...
גשרי הניהול מתגלים דרך החוזה החי של בובי. פעולת commit שאינה מפורסמת בחוזה
אינה מוצגת ואינה נשלחת; אין ביישום מסלול שעוקף את הגשר בקריאת שירות ישירה.
